...
public class PopulaBanco {
	...
	public static void main(String[] args) {
		...
		Autor assis = geraAutor("Machado de Assis", "massis@email.com");
		em.persist(assis);

		Autor amado = geraAutor("Jorge Amado", "joa@email.com");
		em.persist(amado);

		Autor coelho = geraAutor("Paulo Coelho", "paco@email.com");
		em.persist(coelho);
